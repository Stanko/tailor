...
(() => {
  ...
  var Tailor = class {
    ...
    measureDistance($current, $measureTo) {
      ...
      if (isLeft || isRight) {
        positions.hHelper1 = [midFrom.x, positions.vertical1[2], to.left, positions.vertical1[3]];
        if (intersectsVertically) {
  ...
  var src_default = Tailor;

  // src/extension-load-tailor.ts
  window.__tailor = new src_default();
})();
